      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            <!-- :style="{pointerEvents:cart.skuNum==1?'none':'auto'}"   cart.skuNum=1时禁用-1超链接-->
            <a href="javascript:void(0)" class="mins" @click="handler('minus', -1, cart)" :style="{pointerEvents:cart.skuNum==1?'none':'auto'}">-</a>
...
export default {
  ...
  computed: {
    ...
    // 判断是否全选
    isAllChecked() {
      // every 每个item的isChecked都为1的话 返回true
