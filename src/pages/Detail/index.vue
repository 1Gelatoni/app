        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 这里的路由跳转前需要发请求 将购买产品的信息通知服务器 服务器进行存储 -->
...
export default {
  ...
  computed:{
    ...
    // 给子组件的数据 
    skuImageList(){
      // 如果服务器的数据没有回来 skuInfo.skuImageList为undefined
  ...
  methods:{
    ...
    // addShopcar(){
      // 派发请求
      // 调用addOrUpdateShopCart函数 返回Promise
      try {
      ...
      /* this.$store.dispatch('addOrUpdateShopCart',{skuId:this.$route.params.skuid,skuNum:this.skuNum}).then((response)=>{
